...
function crearTablero() {
    ...
    // pongo los títulos
    document.getElementById("juego").rows[0].cells[0].textContent = "Jugadas";
    console.log(part[1])
    var cuenta = 0
...
function valorOk(c, f) {
    ...
    var ptos = Number(document.getElementById("sumando").value)
    if (count == 0) {
        console.log(count)
        document.getElementById("juego").rows[f].cells[c].textContent = ptos;
    } else {
        document.getElementById("juego").rows[f].cells[c].textContent = Number(ptos) + Number(document.getElementById("juego").rows[f-1].cells[c].textContent);
        document.getElementById("juego").rows[f-1].cells[c].style = "text-decoration:line-through; text-align: center"
...
if (Number(ptos) + Number(document.getElementById("juego").rows[f-1].cells[c].textContent)==10000) {
    window.alert("Ganaste el partido!!!")
}
}
...
function suma50() {
    document.getElementById("sumando").value = Number(document.getElementById("sumando").value) + 50
}

function suma100() {
    document.getElementById("sumando").value = Number(document.getElementById("sumando").value) + 100
}

function suma1000() {
    document.getElementById("sumando").value = Number(document.getElementById("sumando").value) + 1000
}

function sumandoACero(){
    document.getElementById("sumando").value=Number(0)
}